  ...
  return (
    <div className="flex flex-wrap justify-around gap-12 py-8">
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-2xl text-mainC2">{original_gravity}</p>
      </div>

      <div className="flex flex-col items-center gap-2">
        <p className="font-semibold ">Final Gravity:</p>
        <p className="text-2xl text-mainC2">{final_gravity}</p>
      </div>

      <div className="flex flex-col items-center gap-2">
        <p className="font-semibold ">ABV:</p>
        <p className="text-2xl text-mainC2">{alcohol_by_volume}</p>
      </div>

      <div className="flex flex-col items-center gap-2">
        <p className="font-semibold ">IBU:</p>
        <p className="text-2xl text-mainC2">{ibu}</p>
      </div>

      <div className="flex flex-col items-center gap-2">
        <p className="font-semibold ">SRM:</p>
        <p className="text-2xl text-mainC2">{srm}</p>
      </div>

      <div className="flex flex-col items-center gap-2">
        <p className="font-semibold ">Mash Ph:</p>
        <p className="text-2xl text-mainC2">{mash_ph}</p>
      </div>
    </div>
  );
};
